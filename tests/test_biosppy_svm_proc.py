...
_atoms = runtime_probes.safe_import_module("ageoa.biosppy.svm_proc.atoms")

cross_validation = _atoms.cross_validation
get_subject_results = _atoms.get_subject_results
