...
def test_runtime_probe_passes_for_quantfin_d12_helpers() -> None:
    for atom_name, module_path, symbol in [
        ...
        ("ageoa.quantfin.rng_skip_d12.mulmod64_inner_step", "ageoa.quantfin.rng_skip_d12.atoms", "mulmod64_inner_step"),
        ("ageoa.quantfin.rng_skip_d12.powmod64", "ageoa.quantfin.rng_skip_d12.atoms", "powmod64"),
        ("ageoa.quantfin.rng_skip_d12.powmod64_inner_step", "ageoa.quantfin.rng_skip_d12.atoms", "powmod64_inner_step"),
