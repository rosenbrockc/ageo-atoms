...
@icontract.ensure(lambda result, **kwargs: result is not None, "RiskAversionInit output must not be None")
...
@icontract.ensure(lambda result, **kwargs: result is not None, "OptimalExecutionTrajectory output must not be None")
