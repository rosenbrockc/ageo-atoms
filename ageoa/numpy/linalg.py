...
@register_atom(witness_np_linalg_solve, name="numpy.linalg.solve")
...
@register_atom(witness_np_linalg_inv, name="numpy.linalg.inv")
...
@register_atom(witness_np_linalg_det, name="numpy.linalg.det")
...
@register_atom(witness_np_linalg_norm, name="numpy.linalg.norm")
