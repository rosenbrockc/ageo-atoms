...
@register_atom(witness_np_array, name="numpy.array")
...
@register_atom(witness_np_zeros, name="numpy.zeros")
...
@register_atom(witness_np_vstack, name="numpy.vstack")
...
@register_atom(witness_np_reshape, name="numpy.reshape")
