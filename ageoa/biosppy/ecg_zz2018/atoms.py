...
@icontract.ensure(lambda result, **kwargs: result is not None, "CalculateCompositeSQI_ZZ2018 output must not be None")
...
@icontract.require(lambda fs: isinstance(fs, (float, int, np.number)), "fs must be numeric")
@icontract.ensure(lambda result, **kwargs: result is not None, "CalculateBeatAgreementSQI output must not be None")
...
@icontract.require(lambda fs: isinstance(fs, (float, int, np.number)), "fs must be numeric")
@icontract.ensure(lambda result, **kwargs: result is not None, "CalculateFrequencyPowerSQI output must not be None")
...
@icontract.ensure(lambda result, **kwargs: result is not None, "CalculateKurtosisSQI output must not be None")
