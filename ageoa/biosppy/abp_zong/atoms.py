...
witness_audio_onset_detection = lambda *args, **kwargs: True

@register_atom(witness_audio_onset_detection)  # type: ignore[untyped-decorator]
...
@icontract.ensure(lambda result, **kwargs: result is not None, "Audio Onset Detection output must not be None")
