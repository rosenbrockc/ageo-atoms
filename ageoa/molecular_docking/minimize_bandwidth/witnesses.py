...
def witness_validate_square_matrix_shape(mat: AbstractArray) -> AbstractArray:
    """Ghost witness for ValidateSquareMatrixShape."""
...
def witness_validate_symmetric_input(mat: AbstractArray) -> AbstractArray:
    """Ghost witness for validate_symmetric_input."""
    result = AbstractArray(
        shape=mat.shape,
        dtype="float64",
    )
