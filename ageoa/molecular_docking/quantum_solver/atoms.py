...
@icontract.ensure(lambda result, **kwargs: all(r is not None for r in result), "QuantumProblemDefinition all outputs must not be None")
...
@icontract.ensure(lambda result, **kwargs: all(r is not None for r in result), "AdiabaticQuantumSampler all outputs must not be None")
...
@icontract.ensure(lambda result, **kwargs: result is not None, "SolutionExtraction output must not be None")
