...
@icontract.require(lambda :  is not None, " cannot be None")
...
def charfuncoption(: Any, cf: Any, charFuncMart: Any, d: Any, damp: Any, damp': Any, disc: Any, exp: Any, f: Any, fg: Any, func1: Any, func2: Any, i: Any, intF: Any, k: Any, leftTerm: Any, log: Any, model: Any, opt: Any, p1: Any, p2: Any, pi: Any, q: Any, realPart: Any, rightTerm: Any, s: Any, strike: Any, tmat: Any, v: Any, v': Any, x: Any, yc: Any) -> Any:
    raise NotImplementedError("Wire to original implementation")

@register_atom(witness_f)
@icontract.ensure(lambda result, **kwargs: result is not None, "F output must not be None")
def f(exp: Any, i: Any, k: Any, leftTerm: Any, realPart: Any, rightTerm: Any, v: Any, v': Any) -> Any:
    raise NotImplementedError("Wire to original implementation")
...
def charfuncoption_ffi(, cf, charFuncMart, d, damp, damp', disc, exp, f, fg, func1, func2, i, intF, k, leftTerm, log, model, opt, p1, p2, pi, q, realPart, rightTerm, s, strike, tmat, v, v', x, yc):
    ...
    return _func(, cf, charFuncMart, d, damp, damp', disc, exp, f, fg, func1, func2, i, intF, k, leftTerm, log, model, opt, p1, p2, pi, q, realPart, rightTerm, s, strike, tmat, v, v', x, yc)

def f_ffi(exp, i, k, leftTerm, realPart, rightTerm, v, v'):
    ...
    _func.restype = ctypes.c_void_p
    return _func(exp, i, k, leftTerm, realPart, rightTerm, v, v')
