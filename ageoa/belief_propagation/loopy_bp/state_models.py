...
class BPState(BaseModel):
    ...
    pgm: ProbabilisticGraphModel | None = Field(default=None)
    msg: dict[str, dict[str, Float[Array, "cardinality"]]] | None = Field(default=None)
    msg_new: dict[str, dict[str, Float[Array, "cardinality"]]] | None = Field(default=None)
